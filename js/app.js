...
function updateContent() {
  ...
  if (S.tab === 'despesas') {
    mc.innerHTML = S.month ? despesasMesHTML() : monthSelectorHTML('despesas');
  } else if (S.tab === 'receitas') {
    mc.innerHTML = S.month ? receitasMesHTML() : monthSelectorHTML('receitas');
  } else {
    mc.innerHTML = gerencialHTML();
  }
    ...
    <div class="row row-c">
      ...
      <div class="donut-card">
        ...
        <div class="donut-legend">
          <div class="l-row"><div class="l-dot" style="background:var(--purple)"></div><span class="l-name">Mayara</span><span class="l-pct">${pM}%</span></div>
          <div class="l-row"><div class="l-dot" style="background:var(--cyan)"></div><span class="l-name">Manuela</span><span class="l-pct">${pN}%</span></div>
        </div>
      </div>
    </div>
      ...
      <div class="panel">
        ...
        <div class="form-bd">
          ...
          <div class="fg">
            ...
            <input class="fc" id="d-val" type="number" min="0" step="0.01" placeholder="0,00">
          </div>
          <button class="btn-add" onclick="FC.addDespesa()">+ Adicionar Despesa</button>
        </div>
      </div>
    </div>`;
}
  ...
  return `
    ...
    <div class="row row-c">
      ...
      <div class="donut-card">
        <div class="donut-wrap"><canvas id="donut-c"></canvas></div>
        <div class="donut-legend">
          <div class="l-row"><div class="l-dot" style="background:var(--green)"></div><span class="l-name">Recanto</span><span class="l-pct">${pR}%</span></div>
          <div class="l-row"><div class="l-dot" style="background:var(--yellow)"></div><span class="l-name">Drinks</span><span class="l-pct">${pD}%</span></div>
        </div>
      </div>
    </div>
    ...
    <div class="cgrid">
      ...
      <div class="panel">
        ...
        <div class="form-bd">
          ...
          <div class="fg">
            <label class="fl">Valor (R$)</label>
            <input class="fc" id="r-val" type="number" min="0" step="0.01" placeholder="0,00">
          </div>
          <button class="btn-add" onclick="FC.addReceita()">+ Adicionar Receita</button>
        </div>
      </div>
    </div>`;
}
